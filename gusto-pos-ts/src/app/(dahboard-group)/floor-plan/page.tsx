...
const FloorPlan: React.FC = () => {
  ...
  const addTable = (shape: "square" | "circle") => {
    ...
    const newTable: Table = {
      ...
      shape,
      label:
        shape === "square" ? `S${tables.length + 1}` : `C${tables.length + 1}`,
        ...
        <Grid size={{ xs: 3 }}>
          <Paper elevation={3} sx={{ padding: 2 }}>
            ...
            <Box mt={2}>
              ...
              <Typography variant="body2">
                4 Seater: {totalSeaters.fourSeater}
              </Typography>
              <Typography variant="body2">
                2 Seater: {totalSeaters.twoSeater}
              </Typography>
              <Typography variant="body2">
                Total Chair:{" "}
                {totalSeaters.fourSeater * 4 + totalSeaters.twoSeater * 2}
              </Typography>
            </Box>
